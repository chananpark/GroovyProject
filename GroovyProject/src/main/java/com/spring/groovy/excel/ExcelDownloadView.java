package com.spring.groovy.excel;
...
public class ExcelDownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(	Map<String, Object> model, 
		...
		Locale locale = (Locale) model.get("locale"); // 넘겨받은 모델(다운로드할 엑셀파일의 정보)
		
		String workbookName = (String) model.get("workbookName"); // 넘겨받은 모델(다운로드할 엑셀파일의 정보)
