...
<div style="margin: 0 auto; width:95%;">
	...
	<div class="" id="insert_schedule" style="width:95%; margin-left: 2.5%;">
		...
		<table style="width:100%;">
			...
			<tr style="vertical-align: middle; height: 70px;"> 
				<th class="col-2"><label class="mr-5" for="select_search" style="font-weight: bold; font-size: 12pt;">공유자</label></th>
				<td class="col-10">
			...
			<tr style="vertical-align: middle; height: 70px;">
				<th class="col-2"><label class="mr-5" for="search_word" style="font-weight: bold; font-size: 12pt;">장소</label></th>
				<td class="col-10">
					<input class="input_width" type="text" id="search_word" name="search_word" placeholder="장소를 입력하세요.">
				</td>
			</tr>
			<tr style="vertical-align: middle; height: 230px;">
				<th class="col-2"><label class="mr-5" for="search_word" style="font-weight: bold; font-size: 12pt;">내용</label></th>
				<td class="col-10">
					<textarea class="input_width" id="search_word" name="search_word" placeholder="내용을 입력하세요." style="height:200px;"></textarea>
				</td>
			</tr>
		...
		<div style="float:right;" class="mr-2 mt-4">
			...
			<button class="btn" style="background-color: #086BDE; color:white; ">수정</button>
		</div>
