...
<div style="margin: 0 auto; width:95%;">
	...
	<div class="" id="insert_schedule" style="width:95%; margin-left: 2.5%;">
		...
		<form name="scheduleFrm">
			...
			<table style="width:100%;">
				<tr class="insert_sche_tr">
					<th class="col-2"><label class="mr-5 insert_sche_title">예약일자</label></th>
					<td class="col-10">
				...
				<tr class="insert_sche_tr">
					<th class="col-2"><label class="mr-5 insert_sche_title">예약 항목 선택</label></th>
					<td class="col-10">
		...
		<div style="float:right;" class="mr-2 mt-4">
			<button class="btn bg-light mr-2" onclick="javascript:location.href='<%= ctxPath%>/schedule/schedule.on'">취소</button> <%-- url 기억하기 만들어주기 --%>
			<button class="btn" id="register" style="background-color: #086BDE; color:white; ">예약</button>
		</div>
